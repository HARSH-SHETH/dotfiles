...
alias j='nvim'
alias sj='sudo nvim'
alias jdiff='vimdiff.nvim'
alias shut='shutdown now'
alias s='ls'
alias q='exit'
alias r='ranger;source ~/.zshrc'
alias n='nnn -C;sfz'
alias sa='sudo apt'
...
alias cfc='nvim ~/.config/compton/compton.conf'
alias sfz='source ~/.zshrc; cat ~/todo.list'
...
#to avoid gibberish string generated by pywal
# clear
source ~/color_scripts/elfman
EDITOR="nvim"
